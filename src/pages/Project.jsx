import { ProjectsBoxCOMP } from "../component/ProjectsBoxCOMP"
...
const iconPortafolio = [react, vite]
        ...
        <section className="section" id='proyectos'>
            ...
            <div className='containerBox'>
                ...
                <ProjectsBoxCOMP
                    ...
                    iconProject={iconPortafolio}
                    url='https://github.com/DonLeonel/Mi-Portafolio'
                    ariaLabel="navega hacia el proyecto alojado en github llamado Mi portafolio"
                />
            </div>
        </section>
    )
